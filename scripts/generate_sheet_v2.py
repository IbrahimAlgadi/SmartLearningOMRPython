...
Usage (from repository root):
  python scripts/generate_sheet_v2.py          # generate both EN + AR HTML
  python scripts/generate_sheet_v2.py --pdf    # also export PDFs (needs playwright)
"""
...
if __name__ == "__main__":
    ...
    for lang in ("en", "ar"):
        ...
        print(f"[{lang.upper()}] HTML saved -> {html_path}")
        if args.pdf:
            to_pdf(str(html_path), str(sheets_dir / f"{stem}.pdf"))
