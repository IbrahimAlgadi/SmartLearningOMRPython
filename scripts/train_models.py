...
Usage (from repository root):
  python scripts/train_models.py --data dataset
  python scripts/train_models.py --data dataset --model bubbles
  python scripts/train_models.py --data dataset --epochs 5 --imgsz 416
